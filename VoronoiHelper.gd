...
static func next_half_edge(e):
	return e - 2 if e % 3 == 2 else e + 1

static func edges_around_point(delaunay, start):
	var result = []
	var incoming = start
	while true:
...
static func triangle_of_edge(e):
	return floor(e / 3)

static func edges_of_triangle(t):
	return [3 * t, 3 * t + 1, 3 * t + 2]

static func points_of_triangle(points, delaunay, t):
...
static func triangle_center(points, delaunay, t, center = "circumcenter"):
...
static func get_voronoi_cells(points, delaunay) -> Array[PackedVector2Array] :
